...
import { getSubcategories2, getSubcategories2Act, getSubcategory2, getSubSubCat, postSubcategory2, putSubcategory2, deleteSubcategory2 } from '../controllers/subcategory2';
import { TokenValidation } from '../libs/verifyToken';
 
const router = Router();

router.get('/', TokenValidation , getSubcategories2);
router.get('/act/all', TokenValidation , getSubcategories2Act);
